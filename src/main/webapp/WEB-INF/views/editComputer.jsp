...
<body>
	<header class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<a class="navbar-brand" href="dashboard.html"><spring:message code="label.title"/></a>
		</div>
	</header>
	<section id="main">
		<div class="container">
				...
				<div class="col-xs-8 col-xs-offset-2 box">
					...
					<form action="editComputer" method="POST">
						...
						<div class="actions pull-right">
							...
							<spring:message code="label.or"/><a href="dashboard.html" class="btn btn-default"><spring:message code="label.cancel"/></a>
						</div>
					</form>
				</div>
			</div>
