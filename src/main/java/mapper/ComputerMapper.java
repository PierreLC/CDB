...
public class ComputerMapper implements RowMapper<Computer> {
	...
	public static ComputerDTO computerToComputerDTO(Computer computer) {
		...
		CompanyDTO companyDTO = new CompanyDTO.Builder().setIdDTO(computer.getCompany().getId())
														.setNameDTO(computer.getCompany().getName())
														.build();
		
		ComputerDTO computerDTO = new ComputerDTO.Builder().setIdDTO(computer.getId())
							 							   .setNameDTO(computer.getName())
							 							   .setIntroducedDTO(computer.getIntroduced())
	...
	public static Computer computerDTOToComputer(ComputerDTO computerDTO) {
		...
		Company company = new Company.Builder().setId(computerDTO.getCompanyDTO().getIdDTO())
											   .setName(computerDTO.getCompanyDTO().getNameDTO())
											   .build();
		
		Computer computer = new Computer.Builder().setId(computerDTO.getIdDTO())
												  .setName(computerDTO.getNameDTO())
												  .setIntroduced(computerDTO.getIntroducedDTO())
												  .setDiscontinued(computerDTO.getDiscontinuedDTO())
												  .setCompany(company)
												  .build();
